...
// source: examples/stream/server/proto/stream.proto

/*
Package stream is a generated protocol buffer package.

It is generated from these files:
	examples/stream/server/proto/stream.proto
...
var _Streamer_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "examples/stream/server/proto/stream.proto",
}

func init() {
	proto.RegisterFile("examples/stream/server/proto/stream.proto", fileDescriptor0)
}
