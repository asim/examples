...
// source: examples/template/api/proto/example/example.proto

/*
Package go_micro_api_template is a generated protocol buffer package.

It is generated from these files:
	examples/template/api/proto/example/example.proto
...
var _Example_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "examples/template/api/proto/example/example.proto",
}

func init() {
	proto.RegisterFile("examples/template/api/proto/example/example.proto", fileDescriptor0)
}
