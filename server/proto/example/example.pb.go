...
// source: examples/server/proto/example/example.proto
...
var _Example_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "examples/server/proto/example/example.proto",
}

func init() {
	proto.RegisterFile("examples/server/proto/example/example.proto", fileDescriptor0)
}
