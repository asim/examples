...
// source: examples/booking/api/hotel/proto/hotel.proto
...
var _Hotel_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "examples/booking/api/hotel/proto/hotel.proto",
}

func init() {
	proto.RegisterFile("examples/booking/api/hotel/proto/hotel.proto", fileDescriptor0)
}
